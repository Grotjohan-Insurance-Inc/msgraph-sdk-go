...
// ByHomeRealmDiscoveryPolicyId gets an item from the github.com/chszchen-nordcloud/msgraph-sdk-go/.servicePrincipals.item.homeRealmDiscoveryPolicies.item collection
