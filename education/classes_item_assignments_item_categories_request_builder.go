...
// ByEducationCategoryId gets an item from the github.com/chszchen-nordcloud/msgraph-sdk-go/.education.classes.item.assignments.item.categories.item collection
