...
// ByEducationCategoryId gets an item from the github.com/chszchen-nordcloud/msgraph-sdk-go/.education.users.item.assignments.item.categories.item collection
