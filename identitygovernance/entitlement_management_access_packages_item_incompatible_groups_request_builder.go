...
// ByGroupId gets an item from the github.com/chszchen-nordcloud/msgraph-sdk-go/.identityGovernance.entitlementManagement.accessPackages.item.incompatibleGroups.item collection
