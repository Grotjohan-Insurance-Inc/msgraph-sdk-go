...
func (m *ItemBackgroundImageRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *ItemBackgroundImageRequestBuilderPutRequestConfiguration) ([]byte, error) {
