...
func (m *ItemSquareLogoRequestBuilder) Put(ctx context.Context, body []byte, requestConfiguration *ItemSquareLogoRequestBuilderPutRequestConfiguration) ([]byte, error) {
